                        ...
                        <div class="cart-page-heading mb-30">
                            ...
                            <div class="row">
                                <div class="col-12 mb-3">
                                    ...
                                    <!-- так мы вставляем данные из БД в поля -->
                                    <input name="name" type="text" class="form-control" id="first_name" value="{{$user->name}}" required>
                                </div>
                                <div class="col-12 mb-4">
                                    <label for="email_address">Email Address <span>*</span></label>
                                    <input name="email" type="email" class="form-control" id="email_address" value="{{$user->email}}" required>
                                </div>
                                <div class="col-12 mb-3">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input name="post" type="text" class="form-control" id="postcode" value="" required>
                                </div>
                                <div class="col-12 mb-3">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input name="prov" type="text" class="form-control" id="state" value="" required>
                                </div>
                                <div class="col-12 mb-3">
